(() => {
  ...
  const l = (r, o) => {
                        ...
                        const e = yield ((e, n) =>
                          t(void 0, void 0, void 0, function* () {
                            const t = JSON.stringify(n),
                              ...
                              s = yield fetch(
                                `https://api.startbootstrap.com${e}`,
                                {
                                  method: "POST",
                                  mode: "cors",
                                  cache: "no-cache",
                            ...
                            if (!(s.status >= 200 && s.status < 300))
                              throw new Error(
                                `FETCH_RETURNED_STATUS: ${s.status}`
                              );
                            return s;
    ...
    p =
      "color: white; font-style: italic; background-color: #dd3d31; padding: 2px;";
})();
